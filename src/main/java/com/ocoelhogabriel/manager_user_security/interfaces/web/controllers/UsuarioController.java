...
import com.ocoelhogabriel.manager_user_security.domain.services.UsuarioServInterface;
...
public class UsuarioController extends SecurityRestController {
	...
	private final UsuarioServInterface userServImpl;

	public UsuarioController(UsuarioServInterface userServImpl) {
